 ...
 */
UCLASS()
class DRAWANDGUESS_API UDAGGameInstance : public UGameInstance
{
	GENERATED_BODY()

public:
	UDAGGameInstance(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	UFUNCTION(BlueprintCallable, Category="DrawAndGuess|Game", meta=(DisplayName="Add Main Menu Message"))
